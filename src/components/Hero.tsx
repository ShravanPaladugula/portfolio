...
export function Hero() {
  ...
  return (
    <section id="top" className="relative overflow-hidden" aria-label="Hero">
      ...
      <div className="relative z-10 mx-auto grid max-w-[1500px] grid-cols-1 items-center gap-10 px-[clamp(1.25rem,4vw,4rem)] pb-20 pt-28 lg:grid-cols-[1fr_220px] lg:gap-14 lg:pb-24 lg:pt-32">
        <div>
          <motion.p
          ...
          >
            <a
              href="#work"
              className="inline-flex items-center bg-fg px-5 py-3.5 font-mono text-[11px] uppercase tracking-[0.2em] text-bg transition-opacity hover:opacity-85"
            >
              See my work
            </a>
            <a
              href={profile.links.resume}
              className="inline-flex items-center border border-fg/50 px-5 py-3.5 font-mono text-[11px] uppercase tracking-[0.2em] text-fg transition-colors hover:bg-fg hover:text-bg"
            >
              Resume
            </a>
            <a
        ...
        >
          <div className="relative aspect-[3/4] w-full overflow-hidden border border-fg/30 bg-[#0c0c0c]">
            <Image
              src="/portrait.jpg"
              alt={`${profile.name} — replace this photo`}
              fill
              priority
